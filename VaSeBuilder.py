...
class VaSeBuilder:
                    ...
                    for vcfVar in vcfFile.fetch():
                        ...
                        if (not self.contexts.variantIsInContext(
                            ...
                            try:
                                ...
                                # results.
                                self.vaseLogger.debug(str(len(variantContextDonorReads)))
                                self.vaseLogger.debug(str(len(variantContextAcceptorReads)))
    ...
    def writeOptionalOutputFiles(self, outPath, contextFile):
        ...
        contextFile.writeAcceptorContextFile(
        ...
        contextFile.writeDonorContextFile(
        ...
        contextFile.writeDonorContextStats(
        ...
        contextFile.writeDonorUnmappedMates(
