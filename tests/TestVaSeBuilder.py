...
class TestVaSeBuilder(unittest.TestCase):
    ...
    def test_determineVariantType_snp(self):
        ...
        self.assertEqual(self.vsBuilder.determineVariantType(variant_ref, variant_alts), variant_type_answer, f"The determined variant type should have been an SNP")
    ...
    def test_determineVariantType_indel(self):
        ...
        self.assertEqual(self.vsBuilder.determineVariantType(variant_ref, variant_alts), variant_type_answer, f"The determined variant type should have been an indel")
    ...
    def test_determineIndelReadRange(self):
        ...
        self.assertListEqual(self.vsBuilder.determineIndelReadRange(variant_position, variant_ref, variant_alts), indel_range_answer, f"The indel read range should have been: {indel_range_answer}")
    ...
    def test_getVariantReads_pos(self):
        ...
        variant_readlist = self.vsBuilder.getVariantReads("16", 247990, 247990, pysam.AlignmentFile("testdata/valbam/SRR1039513.bam", 'rb'))
    ...
    def test_getVariantReads_neg(self):
        self.assertListEqual(self.vsBuilder.getVariantReads("16", 1, 1, pysam.AlignmentFile("testdata/valbam/SRR1039513.bam", 'rb')), [], "Both list should be empty")
    ...
    def test_determineContext_pos(self):
        ...
        variant_reads = self.vsBuilder.getVariantReads("16", 247990, 247990, pysam.AlignmentFile("testdata/valbam/SRR1039513.bam", 'rb'))
        self.assertListEqual(self.vsBuilder.determineContext(variant_reads, 247990), context_answer, f"The obtained context should have been: {context_answer}.")
    ...
    def test_determineLargestContext(self):
        ...
        self.assertListEqual(self.vsBuilder.determineLargestContext(200, acceptor_context, donor_context), context_answer, f"")
    ...
    def test_getCreationId(self):
        ...
        self.assertEqual(vasebuilder_obj.getCreationId(), creationid_answer, f"The returned VaSeBuilder identifier should have been: {creationid_answer}")
    ...
    def test_getCreationDate(self):
        ...
        self.assertEqual(vasebuilder_obj.getCreationDate(), creation_data_answer, f"The returned VaSeBuilder creation data should have been: {creation_data_answer}")
