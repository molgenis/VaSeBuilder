...
class TestParamChecker(unittest.TestCase):
    ...
    def test_checkLog_pos(self):
        self.assertEqual(self.paramCheck.check_log("testdata/outDir/vaseutest.log"), "testdata/outDir/vaseutest.log", "The log location should have been testdata/outDir/vaseutest.log")
    ...
    def test_checkFolderContents_pos(self):
        self.assertEqual(self.paramCheck.check_folder_contents("testdata/bamDir", "bam"), 2, "Two bam files should have been found")
    
    # Tests that the provided testdata folder 'bamDir' contains no VCF files
    def test_checkFolderContents_neg(self):
        self.assertEqual(self.paramCheck.check_folder_contents("testdata/bamDir", "vcf"), 0, "No VCF files should have been found")
    ...
    def test_checkParameters_pos(self):
        self.assertTrue(self.paramCheck.check_parameters(self.paramList))
