...
vaseArgPars.add_argument("--templatebam", required=True, help="Location of the BAM file to modify and produce new FastQ.", metavar="VALBAM")
vaseArgPars.add_argument("--templatefq1", help="Location and name of the first fastq in file.", metavar="VALFIN1")
vaseArgPars.add_argument("--templatefq2", help="Location and name of the second fastq in file.", metavar="VALFIN2")
...
vaseArgPars.add_argument("--templatebread", required=True, help="")
