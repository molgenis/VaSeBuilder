...
vaseArgPars.add_argument("--templatebam", required=True, help="Location of the BAM file to modify and produce new FastQ.", metavar="TEMPLATEBAM")
vaseArgPars.add_argument("--templatefq1", help="Location and name of the first fastq in file.", metavar="TEMPLATEFQ1")
vaseArgPars.add_argument("--templatefq2", help="Location and name of the second fastq in file.", metavar="TEMPLATEFQ2")
...
vaseArgPars.add_argument("--templatebread", required=True, help="Location to write the variants and associated template BAM reads to.", metavar="TEMPLATEBREAD")
