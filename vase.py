...
class VaSe:
	...
	def getVaSeParameters(self):
		...
		vaseArgPars.add_argument("-1", "--templatefq1", nargs="*", required=True, help="Location and name of the first fastq in file.", metavar="TEMPLATEFQ1")
		vaseArgPars.add_argument("-2", "--templatefq2", nargs="*", required=True, help="Location and name of the second fastq in file.", metavar="TEMPLATEFQ2")
